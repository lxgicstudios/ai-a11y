...
![npm](https://img.shields.io/npm/v/ai-a11y)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-a11y)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# Accessibility testing and audit toolkit for modern web applications

AI-powered accessibility checker for web applications. Detects WCAG violations and provides automated remediation suggestions.
## Usage
...
[![npm version](https://badge.fury.io/js/ai-a11y.svg)](https://badge.fury.io/js/ai-a11y)
